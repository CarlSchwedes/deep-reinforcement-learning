...
from model import QNetwork, DQNNatureNetwork
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, qnetwork_class=QNetwork,
        ...
        self.is_cnn = qnetwork_class == DQNNatureNetwork
        ...
        # Q-Network
        self.qnetwork_local = qnetwork_class(state_size, action_size, seed).to(device)
        self.qnetwork_target = qnetwork_class(state_size, action_size, seed).to(device)
        if self.is_cnn:
